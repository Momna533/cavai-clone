...
import AutoScroll from "../../components/AutoScrollXand-X/AutoScrollXand-X";
function Home() {
  ...
  //scroll_2
    ...
    return(
        ...
        <div className="scroll_content">
            ...
            <button className="scroll_btn_2" onClick={scrollRight}>
                <svg width="16px" height="16px" viewBox="0 0 16 16" version="1.1"
            //  xmlns="http://www.w3.org/2000/svg"
            //   xmlns:xlink="http://www.w3.org/1999/xlink"
      ...
      <div ref={scrollContainerRef} className="scroll_slider">
        <div className="scroll_slider_entry">
            <img src={require("../../assets/adidas_zalando_cover.webp")} alt="scroll_img" />
            <h5>Cases | lorem ipsum</h5>
        ...
        <div className="get_started_products">
                    <div className="get_started_products_left">
                        <h2>Lorem ipsum dolor sit amet.</h2>
                    </div>
                    <div className="get_started_products_right">
                        <p>Lorem, ipsum dolor sit amet consectetur adipisicing elit. Deleniti nihil non at laborum vitae! Fuga modi esse tempora perferendis voluptate?</p>
                        <a href="">
                            <span>Products</span>
                            <svg width="16px" height="16px" viewBox="0 0 16 16" version="1.1"
            //  xmlns="http://www.w3.org/2000/svg"
            //   xmlns:xlink="http://www.w3.org/1999/xlink"
              ><title>Arrow right</title><g id="icon/expot/button-arrow" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd"><path d="M7.90339859,-4.61852778e-14 L15.9033986,8 L7.90339859,16 L7.24376293,15.3403643 L14.155,8.428 L-4.33431069e-13,8.42846739 L-4.33431069e-13,7.49560168 L14.08,7.495 L7.24376293,0.659635666 L7.90339859,-4.61852778e-14 Z" id="button-arrow" fill="currentColor" fill-rule="nonzero"></path></g></svg>
                        </a>
                    </div>
                </div>
                <div className="get_started_line"></div>
                <div className="get_started_cloud">
                <div className="get_started_products_left">
                        <h2>Lorem ipsum dolor sit amet.</h2>
                    </div>
                    <div className="get_started_products_right">
        ...
        <AutoScroll color="#fff" entries={
          <div className="scroll_2_content_entry">
            <img src={require("../../assets/logo-7-copy@2.webp")} alt="scroll_img" width={"100px"} height={"100px"} />,
            <img src={require("../../assets/logo-1-copy@2.webp")} alt="scroll_img" width={"200px"} />,
            <img src={require("../../assets/logo-6-copy@2.webp")} alt="scroll_img" width={"200px"} />,
            <img src={require("../../assets/logo-8-copy@2.webp")} alt="scroll_img" width={"200px"} />,
            <img src={require("../../assets/logo-9-copy@2.webp")} alt="scroll_img" width={"100px"} />,
            <img src={require("../../assets/logo-7-copy@2.webp")} alt="scroll_img" width={"100px"} height={"100px"} />,
            <img src={require("../../assets/logo-1-copy@2.webp")} alt="scroll_img" width={"200px"} />,
            <img src={require("../../assets/logo-6-copy@2.webp")} alt="scroll_img" width={"200px"} />,
            <img src={require("../../assets/logo-8-copy@2.webp")} alt="scroll_img" width={"200px"} />,
        ...
        <Letstalk  color="radial-gradient(circle, #FFFE00 0%, #FEF806 48.04%, rgba(254,248,6,0) 100%)" />
        <Newsletter />
        </>
    );
  }
