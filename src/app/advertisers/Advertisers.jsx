...
import AutoScrollEntry from "../../components/AutoScrollXand-X/AutoScrollEntry";
...
function Advertisers() {
    return(
        ...
        <section className="home">
            <div className="home_gradient_background home_gradient_background_products"></div>
            <div className="home_content">
            <div className="home_content_text">
                    <h1>lorem ipsum Advertisers</h1>
        ...
        <section className="conversation">
            <div className="conversation_content">
                <div className="conversation_content_entry">
                    <h2>Conversational Bubble</h2>
                    <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Eos, dicta eligendi odit soluta aspernatur aliquam eum. Numquam deserunt repellendus rerum?</p>
                    <div className="conversation_content_entry_icons">                        <div className="conversation_content_entry_icon">icon</div>
                        <div className="conversation_content_entry_icon">icon</div>
                        <div className="conversation_content_entry_icon">icon</div></div>
                    <img src={require("../../assets/convobubble.webp")} alt="conversation_img" />
                </div>
                <div className="conversation_content_entry">
                    <h2>Conversational Bubble</h2>
                    <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Eos, dicta eligendi odit soluta aspernatur aliquam eum. Numquam deserunt repellendus rerum?</p>
                    <div className="conversation_content_entry_icons">
                        <div className="conversation_content_entry_icon">icon</div>
                        <div className="conversation_content_entry_icon">icon</div>
                        <div className="conversation_content_entry_icon">icon</div>
                    </div>
        ...
        <Testimonials />
        <Letstalk  color="radial-gradient(circle, rgb(0, 255, 255) 0%, rgb(0, 255, 255) 37.39%, rgba(0, 255, 255, 0) 100%)" />
        <Newsletter />
        </>
    );
  }
